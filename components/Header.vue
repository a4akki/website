  ...
  <div class="container px-4 mx-auto">
    ...
    <div class="flex flex-wrap mt-6 -mx-4">
      <div class="w-full lg:w-1/2 p-4">
        <h1 class="text-5xl lg:text-7xl font-semibold mb-6 max-w-sm lg:max-w-md mt-14">Unlock collective knowledge</h1>
        <p class="text-gray-600 text-lg mb-10 max-w-lg">Fuel your curiosity, expand your horizons, and achieve greatness by joining a vibrant community of learners.</p>
        <div class="flex items-center gap-6 flex-wrap">
          <a class="h-16 inline-flex items-center justify-center py-4 px-6 rounded-full bg-orange-500 border border-orange-600 shadow font-bold font-heading text-white hover:bg-orange-600 focus:ring focus:ring-orange-200 transition duration-200" href="#">Get Started</a>
          <div class="border border-gray-100 rounded-lg px-3 py-2 flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewbox="0 0 10 10" fill="none"><circle cx="5" cy="5" r="5" fill="#FF7100"></circle></svg>
            <p class="text-xs">
              <span class="font-semibold">1236</span>
              <span></span>
      ...
      <div class="w-full lg:w-1/2 p-4">
        <img class="lg:ml-auto" src="https://shuffle.dev/solstice-assets/images/hero/platform-half.png" alt="">
      </div>
    </div>
  </div>
</section>
