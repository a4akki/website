<template>
    <section
      ...
      style="background-image: ; background-position: center"
    >
      <div class="mx-auto px-4 bg-black ">
        <div class="mx-4 flex flex-wrap">
          <div class="w-full px-4 md:w-1/3">
            <div
              class="h-full rounded-md p-8 text-center transition duration-200 hover:bg-orange-500 hover:shadow-xl "
            >
              <div
                class="mx-auto mb-7 inline-flex h-16 w-16 items-center justify-center rounded-lg bg-black text-white "
              >
                <svg
                  width="24"
                  height="21"
              ...
              <h3 class="mb-3 text-xl font-bold leading-tight md:text-2xl text-white">
                Stay Connected
              </h3>
              <p class="text-coolGray-500 font-medium text-white">
                Stay connected with me and get a glimpse into my daily life.
              </p>
            </div>
          </div>
          ...
          <div class="w-full px-4 md:w-1/3 ">
            <div
              class="h-full rounded-md p-8 text-center transition duration-200 hover:bg-white hover:shadow-xl text-white hover:text-black"
            >
              <div
                class="mx-auto mb-7 inline-flex h-16 w-16 items-center justify-center rounded-lg bg-black text-white hover:text-black"
              >
                <svg
                  width="22"
                  height="12"
              ...
              <h3 class="mb-3 text-xl font-bold leading-tight md:text-2xl">
                Join community
              </h3>
              <p class="text-coolGray-500 font-medium">
                Join my community and stay updated on upcoming Videos and
                collaborations.
              </p>
            </div>
          </div>
          ...
          <div class="w-full px-4 md:w-1/3">
            <div
              class="h-full rounded-md p-8 text-center transition duration-200 hover:bg-green-500 hover:shadow-xl"
            >
              <div
                class="mx-auto mb-7 inline-flex h-16 w-16 items-center justify-center border-solid  rounded-lg bg-black text-white"
              >
                <svg class=""
                  width="22"
                  height="18"
              ...
              <p class="text-coolGray-500 font-medium text-white">
                If you enjoy my content and want to contribute, consider
                supporting me.
              </p>
            </div>
          </div>
